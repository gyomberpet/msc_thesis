...
class TransfuserFeatureBuilder(AbstractFeatureBuilder):
    ...
    def compute_features(self, agent_input: AgentInput) -> Dict[str, torch.Tensor]:
        ...
        features["camera_feature"], features["camera_feature_back"] = self._get_camera_feature(agent_input)
    ...
    def _get_camera_feature(self, agent_input: AgentInput) -> Tuple[torch.Tensor]:
        """
        ...
        return tensor_image, tensor_back_image
