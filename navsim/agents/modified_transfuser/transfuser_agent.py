...
from navsim.agents.modified_transfuser.transfuser_config import TransfuserConfig
from navsim.agents.modified_transfuser.transfuser_model import TransfuserModel
...
class TransfuserAgent(AbstractAgent):
    ...
    def get_training_callbacks(self) -> List[pl.Callback]:
        """Inherited, see superclass."""
        return [TransfuserCallback(self._config), EarlyStopping(monitor="val/loss", min_delta=0.00, patience=50, verbose=False, mode="min")]
